...
**1. What is hemoglobin and why do CKD patients often have low hemoglobin? What hormone do kidneys produce that affects hemoglobin?**

Your answer:

---

**2. What is the relationship between coronary artery disease (cad) and chronic kidney disease? Why do these conditions often occur together?**

Your answer:

---

**3. Why is blood glucose (bgr) monitored in kidney disease patients? What is the connection between diabetes and CKD?**

Your answer:

---

**4. What are pus cells (pc) and pus cell clumps (pcc) in urine? What might their presence indicate about kidney or urinary tract health?**
...
### 3.2 Hemoglobin (hemo) Validation (5 points)

Hemoglobin is crucial for oxygen transport. Normal range is typically 12-16 g/dL for women and 14-18 g/dL for men. CKD often causes anemia (low hemoglobin).

Write code to examine hemoglobin values closely.
...
- What is the range of hemoglobin values in this dataset?

- How many patients have severely low hemoglobin (<8 g/dL)?

- What might severely low hemoglobin values indicate clinically?
...
## Part 4: Create Clinical Hemoglobin Groups (10 points)

Create a new column called `hemo_category` that categorizes patients into clinically-meaningful hemoglobin groups.

### Version C: Anemia Severity Classification

Use these categories based on WHO anemia classification:

| Hemoglobin Category | Range (g/dL) | Clinical Rationale |
|--------------------|--------------|-------------------|
| Severe Anemia | <7 | Life-threatening, transfusion often needed |
| Moderate Anemia | 7-9.9 | Significant symptoms, treatment required |
| Mild Anemia | 10-11.9 | Mild symptoms, monitoring and iron/EPO may help |
| Normal | 12-15.9 | Healthy hemoglobin range |
| High | 16+ | Polycythemia, may indicate dehydration or other issues |

### Your Code:

```python
# First, handle any missing hemo values if present
# Then create the hemo_category column
...
```python
# Show counts per hemoglobin category

```

### Calculate CKD rate by hemoglobin category:

```python
# Calculate the percentage of patients who have CKD in each hemoglobin category
...
**1. How many patients are in each hemoglobin category?**

Your answer:

---

**2. What is the CKD rate (percentage) for each hemoglobin category?**

Your answer:

---

**3. Is there a relationship between hemoglobin levels and CKD prevalence? Does this match what you learned in your clinical research about kidneys and anemia?**
...
1. **A question about blood glucose levels and CKD:**


---

2. **A question comparing patients with coronary artery disease vs. without:**


---

3. **A question about the combination of hypertension AND diabetes:**
...
Write one question about **dietary factors or lifestyle** that this dataset cannot answer, and explain why.
...
**"What is the average hemoglobin level for patients with CKD vs. patients without CKD?"**
...
What is the difference in average hemoglobin between CKD and non-CKD patients? Why does this make clinical sense given what you know about kidneys and blood production?
...
- [ ] **Part 4:** Created `hemo_category` column using the **Anemia Severity Classification**
- [ ] **Part 4:** Calculated CKD rate by hemoglobin category with interpretation
- [ ] **Part 5:** Three research questions (blood glucose, CAD, hypertension+diabetes)
- [ ] **Part 5:** One unanswerable question about dietary/lifestyle factors
- [ ] **Part 5:** Hemoglobin groupby analysis
...
| Part 4: Hemoglobin Groups | 10 | Working code that creates correct groups AND meaningful interpretation |
